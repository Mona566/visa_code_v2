...
**Timestamp**: 2025-12-22 21:01:18

**URL**: https://www.visas.inis.gov.ie/AVATS/FormAssistance.aspx
...
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Expires" content="0"><meta http-equiv="Cache-Control" content="no-cache"><meta http-equiv="Pragma" content="no-cache"><title>
    ...
    <form name="aspnetForm" method="post" action="./FormAssistance.aspx" onsubmit="javascript:return WebForm_OnSubmit();" id="aspnetForm">
<div>
<input type="hidden" name="__EVENTTARGET" id="__EVENTTARGET" value="">
<input type="hidden" name="__EVENTARGUMENT" id="__EVENTARGUMENT" value="">
<input type="hidden" name="__LASTFOCUS" id="__LASTFOCUS" value="">
<input type="hidden" name="__VIEWSTATE" id="__VIEWSTATE" value="/wEPDwUKLTczOTExODQyMg9kFgJmD2QWAgIDD2QWAgIPD2QWBAIBD2QWAgIFDw8WAh4EVGV4dAUIODExNDQxODJkZAIHDxBkZBYAZGTQByRVaD9OFhithF4mtNb4kcxdKDjTXH4lvKuoqofoYw==">
</div>
...
<div>
	...
	<input type="hidden" name="__VIEWSTATEGENERATOR" id="__VIEWSTATEGENERATOR" value="81F667FB">
	<input type="hidden" name="__EVENTVALIDATION" id="__EVENTVALIDATION" value="">
</div>
    <table width="100%">
        <tbody><tr>
            <td colspan="2">
	...
	<tr>
	    <td>
			...
			<span id="ctl00_ContentPlaceHolder1_TransactionNumberControl1_lblTransactionNumber" class="TransactionNumberText">81144182</span>
                ...
                <span id="ctl00_ContentPlaceHolder1_lblError" class="ApplicationClientErrorText" style="display:inline-block;width:282px;"></span></td>
        </tr>
        <tr>
            <td colspan="2" class="mandatoryInformation">* Denotes mandatory field</td>
        </tr>
        <!-- DK 19 07 2007 Included valign property to align the text and radio buttons in one line-->
        <tr>
            <td class="LabelText" valign="top" width="30%">
                Did you receive any assistance in completing this form from an agent/agency? <font color="red">*</font>
            </td>
            <td valign="top" width="70%">
                <table id="ctl00_ContentPlaceHolder1_rdblstAgency" class="RadioButtonText" cellspacing="0" cellpadding="0" border="0" style="border-collapse:collapse;">
	<tbody><tr>
		<td><input id="ctl00_ContentPlaceHolder1_rdblstAgency_0" type="radio" name="ctl00$ContentPlaceHolder1$rdblstAgency" value="1" onclick="javascript:setTimeout('__doPostBack(\'ctl00$ContentPlaceHolder1$rdblstAgency$0\',\'\')', 0)"><label for="ctl00_ContentPlaceHolder1_rdblstAgency_0">Yes</label></td><td><input id="ctl00_ContentPlaceHolder1_rdblstAgency_1" type="radio" name="ctl00$ContentPlaceHolder1$rdblstAgency" value="0" onclick="javascript:setTimeout('__doPostBack(\'ctl00$ContentPlaceHolder1$rdblstAgency$1\',\'\')', 0)"><label for="ctl00_ContentPlaceHolder1_rdblstAgency_1">No</label></td>
	</tr>
</tbody></table>
                <span id="ctl00_ContentPlaceHolder1_rqfldAgency" class="ApplicationClientErrorText" style="color:Red;visibility:hidden;">Please specify whether you received any assistance or not.</span>
            </td>
        </tr>
        <!-- DK 19 07 2007 End of - Included valign property to align the text and radio buttons in one line-->
        <tr>
...
<script type="text/javascript">
//<![CDATA[
var Page_Validators =  new Array(document.getElementById("ctl00_ContentPlaceHolder1_rqfldAgency"));
//]]>
</script>

<script type="text/javascript">
//<![CDATA[
var ctl00_ContentPlaceHolder1_rqfldAgency = document.all ? document.all["ctl00_ContentPlaceHolder1_rqfldAgency"] : document.getElementById("ctl00_ContentPlaceHolder1_rqfldAgency");
ctl00_ContentPlaceHolder1_rqfldAgency.controltovalidate = "ctl00_ContentPlaceHolder1_rdblstAgency";
ctl00_ContentPlaceHolder1_rqfldAgency.errormessage = "Please specify whether you received any assistance or not.";
ctl00_ContentPlaceHolder1_rqfldAgency.evaluationfunction = "RequiredFieldValidatorEvaluateIsValid";
ctl00_ContentPlaceHolder1_rqfldAgency.initialvalue = "";
//]]>
</script>
